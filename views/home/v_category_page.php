            ...
            <div class="container">
                <div class="grid wide">
                    ...
                    <div class="row container__item">
                        ...
                        <div class="col l-12 m-12 c-12">
                            <div class="container-nav">
                                ...
                                <?php foreach( $get_category as $data){?>
                                    <li class="container-nav__item <?= ($data->{'id'} == $_GET['id']) ? 'active-link' : '' ?>">
                                        <a href="category-page.php?id=<?=$data->{'id'};?>" class="container-nav__item-link <?= ($data->{'id'} == $_GET['id']) ? 'active-li' : '' ?>"><?=$data->{'ten_loai'}?></a>
                                    </li>
                                    <?php }?>
                                </ul>
                            </div>
                        ...
                        <h2 style="color: red;font-size:24px;">HÀNG CÙNG LOẠI</h2>
                        <div class="col l-12 m-12 c-12">
                            <div class="container-product">
                                <div class="row no-gutters ">
                                    <!-- Thêm từng điện thoại vào -->
                                    <?php foreach ($get_category_pro as $data){?>
